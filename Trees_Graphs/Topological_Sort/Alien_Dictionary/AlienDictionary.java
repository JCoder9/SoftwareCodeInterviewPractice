/**
 * Topological Sort - Alien Dictionary (LC 269)
 * 
...
//                  validates each — O(k! × n × L)"
//   2. Problem:    "For k=10 unique chars: 10! = 3.6M permutations"
//   3. Transition: "Build graph from adjacent words, topological sort — O(C)"
//
// // Conceptual - would generate all permutations and validate
// public String alienOrderNaive(String[] words) {
//     // Get unique characters
//     // Try all permutations of characters
//     // For each permutation, check if it validates all word pairs
//     // Return first valid ordering
//     return "";
// }
// ─────────────────────────────────────────────────────────────────────────────
